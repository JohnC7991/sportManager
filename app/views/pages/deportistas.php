...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="crear_deportista.php" class="btn btn-success">Nuevo deportista</a>
    </div>
                ...
                <?php foreach ($rows as $row): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($rol === 3): ?>
                                <a href="eliminar_deportista.php?id=<?= urlencode((string)$row->id_deportista) ?>" class="btn btn-danger btn-sm">Eliminar</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
